...
/**
 * @author Moritz Kobel
 * based on Jakob Drangmeister's GrailsConcurrentLinktedMapCacheManagerTests
 */
class GrailsGuavaCacheManagerTests {

   private GrailsGuavaCacheManager manager = new GrailsGuavaCacheManager()
   ...
   void testGetCacheNames() {
      ...
      assert manager.cacheMap.values().every { it instanceof GrailsGuavaCache }
   }
