...
[source,groovy]
----
include::../../../../grails-app/services/com/demo/BasicCachingService.groovy[tags=get_data,indent=0]
----

[source,groovy]
----
include::../../../test/groovy/com/demo/BasicCachingServiceNoCacheManagerSpec.groovy[]
----
...
[source,groovy]
----
include::../../../test/groovy/com/demo/BasicCachingServiceSpec.groovy[]
----
